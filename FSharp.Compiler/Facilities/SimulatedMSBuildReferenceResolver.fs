...
module  FSharp.Compiler.CodeAnalysis.SimulatedMSBuildReferenceResolver
...
[<Literal>]
let  Net452 = "v4.5.2" // not available in Dev15 MSBuild version
...
let  getResolver () = SimulatedMSBuildResolver
